...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Our contact</h4>
                </div>
            </div>
        ...
        <form action="{{ route('ourcontact.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="landmarks_uz" class="form-control" name="landmarks_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="landmarks_ru" class="form-control" name="landmarks_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="landmarks_en" class="form-control" name="landmarks_en">
                      ...
                      <div class="row" style="margin-top: 15px">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="adsress_uz" class="form-control" name="adsress_uz">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="adsress_ru" class="form-control" name="adsress_ru">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="adsress_en" class="form-control" name="adsress_en">
