...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('projectnew.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            ...
                            <input type="text" id="ongoing_name_uz" class="form-control" name="ongoing_name_uz">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="ongoing_name_ru" class="form-control" name="ongoing_name_ru">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="ongoing_name_en" class="form-control" name="ongoing_name_en">
