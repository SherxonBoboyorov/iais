...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Centers</h4>
                </div>
            </div>
        ...
        <form action="{{ route('centerabout.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            <label>Topic and Region</label>
                            <select name="centerfilter_id" id="centerfilter_id" class="form-control">
                                @foreach ($centerfilters as $centerfilter)
                                    <option value="{{ $centerfilter->id }}">{{ $centerfilter->tropic_ru }}</option>
                                @endforeach
                            </select>
