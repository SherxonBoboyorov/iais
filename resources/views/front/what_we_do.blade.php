            ...
            <div class="history__cart">
                ...
                <aside>
                    ...
                    <ul class="history__menu">
                        ...
                        <li>
                            <a href="{{ route('aboutwhats') }}" class="history__menu__link active">@lang('main.what_we_do')</a>
                        </li>
                ...
                <div class="history__list">
                    ...
                    <h2 class="outputs__title__h2">{{ $aboutwhat->{'title_' . app()->getLocale()} }}</h2>

                    <div class="history__list__text clearfix">
                        <p>
                            {!! $aboutwhat->{'content_' . app()->getLocale()} !!}
                       </p>
                    </div>
                    @endforeach
