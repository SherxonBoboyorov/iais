            ...
            <div class="history__cart">
                ...
                <aside>
                    ...
                    <ul class="history__menu">
                        <li>
                            <a href="{{ route('support') }}" class="history__menu__link">@lang('main.our_donors')</a>
                        </li>

                        <li>
                            <a href="{{ route('donate') }}" class="history__menu__link active">@lang('main.donate')</a>
                        </li>
                    </ul>
                </aside>
                ...
                <div class="history__list">
                    ...
                    <h2 class="outputs__title__h2">{{ $donateabout->{'title_' . app()->getLocale()} }}</h2>

                    <div class="history__list__text clearfix">
                        <p>
                            {!! $donateabout->{'content_' . app()->getLocale()} !!}
                       </p>
                    </div>
                    @endforeach
